...
dic_intensif = ot.merge_vad(dic_vad, dic_intensif)
#dic_elal_bi = ot.merge_vad(dic_vad, dic_intensif_bi)
ot.make_csv_als(dic_elal, 5, f_in_als,"out_files/mots_als_ELAL.csv", False)
ot.make_csv_fr(dic_intensif, f_token_fr, "out_files/mots_fr_NRC.csv", False)
ot.make_csv_moyen("out_files/mots_fr_NRC.csv","out_files/moyenne_fr_NRC.csv", False)
